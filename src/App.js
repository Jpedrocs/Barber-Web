...
function App() {
  return(
    ...
    <section className="about-container">
      ...
      <div className="about-text"> 
        ...
        <p>Barbeiro desde os 13 anos por influência familiar, Seu Zé sempre gostou de mudanças e de desafios. 
          Há pouco mais de cinco anos, insatisfeito com a mesmice, José foi buscar referências no exterior e resolveu
           trazer um conceito até em então novo para o Brasil. Pioneiro no estilo sofisticado de barbearias no país, 
           atualmente, ele empresaria três unidades Seu Zé em Belo Horizonte: “Antigamente cortar cabelo era algo 
    ...
    <div className="qualities-box">
      ...
      <ContentBox tag={"Domicílio"} img={Domicilio} alt={"domicilio"}></ContentBox>
